<x-layout>
    ...
    <form action="/register" method="POST">
        ...
        <div class="mb-4">
            <label for="name" class="block mb-2 text-xl font-md text-gray-900 dark:text-white">Name</label>
            <input type="text" name="name" class="block p-2.5 w-full text-xl text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        <div class="space-x-2">
            <button class="text-white text-xl bg-blue-700 hover:bg-blue-800 rounded-lg text-lg px-5 py-2.5">Register</button>
